...
class PizzaDataConfiguration {
    ...
    static let sauceTopping: [String] = ["BBQ Sauce long text long text long text", "Alfredo Sauce", "Hearty Marinara Sauce", "Ranch Dressing", "Garlic Parmesan"]
    static let meatTopping: [String] = ["Pepperoni", "Sauce", "Beef", "Ham", "Bacon", "Chicken"]
